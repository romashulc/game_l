...
timestamps {
    node ('agent1') {
        ...
        stage ('deploy - Build') {
            ...
            sshPublisher(publishers: [sshPublisherDesc(configName: 'new_deploy', transfers: [sshTransfer(execCommand: '', execTimeout: 120000, sourceFiles: 'v3.2/gameoflife.war', removePrefix: 'v3.2')], usePromotionTimestamp: false, useWorkspaceInPromotion: false, verbose: true)])
        }
    }
}